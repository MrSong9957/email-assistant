...
运行环境为 Docker 开发容器（基础镜像 `s7620605/claude-code-opencode`，含 Python 3 + Node.js 20）。

Obsidian 知识库（GitHub 仓库 `MrSong9957/Obsidian`）挂载在 `/home/app/obsidian`（9p）。记忆查找遵循 MEMORY.md → README.md → wiki/ 三层流程。
